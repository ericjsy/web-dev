<?php
	...
	$fname = clean($_POST['txtFirstName']);
	$lname = clean($_POST['txtLastName']);
	$login = clean($_POST['txtNewUser']);
	$password = clean($_POST['txtNewPassword']);
	$cpassword = clean($_POST['txtVerify']);
	...
	//Create INSERT query
	$qry = "INSERT INTO members(firstname, lastname, login, passwd) VALUES('$fname','$lname','$login','".md5($_POST['txtNewPassword'])."')";
	$result = @mysqli_query($GLOBALS["___mysqli_ston"], $qry);
